 ...
 * Command: /mongoose-os/tools/mgos_gen_config.py --c_name=mgos_config --c_global_name=mgos_sys_config --dest_dir=/data/fwbuild-volumes/2.19.1/apps/mos-esp32-oled/esp32/build_contexts/build_ctx_981280184/build/gen/ /mongoose-os/src/mgos_debug_udp_config.yaml /mongoose-os/platforms/esp32/src/esp32_sys_config.yaml /data/fwbuild-volumes/2.19.1/apps/mos-esp32-oled/esp32/build_contexts/build_ctx_981280184/build/gen/mos_conf_schema.yml
 */
...
/* rpc.udp type struct mgos_config_rpc_udp */
...
static inline bool mgos_config_rpc_udp_parse(struct mg_str json, struct mgos_config_rpc_udp *cfg) {
  mgos_config_rpc_udp_set_defaults(cfg);
  return mgos_conf_parse_sub(json, mgos_config_rpc_udp_get_schema(), cfg);
}
static inline bool mgos_config_rpc_udp_emit(const struct mgos_config_rpc_udp *cfg, bool pretty, struct json_out *out) {
  return mgos_conf_emit_json_out(cfg, NULL, mgos_config_rpc_udp_get_schema(), pretty, out);
}
static inline bool mgos_config_rpc_udp_emit_f(const struct mgos_config_rpc_udp *cfg, bool pretty, const char *fname) {
  return mgos_conf_emit_f(cfg, NULL, mgos_config_rpc_udp_get_schema(), pretty, fname);
}
static inline bool mgos_config_rpc_udp_copy(const struct mgos_config_rpc_udp *src, struct mgos_config_rpc_udp *dst) {
  return mgos_conf_copy(mgos_config_rpc_udp_get_schema(), src, dst);
}
static inline void mgos_config_rpc_udp_free(struct mgos_config_rpc_udp *cfg) {
  return mgos_conf_free(mgos_config_rpc_udp_get_schema(), cfg);
}
...
struct mgos_config_rpc {
  ...
  struct mgos_config_rpc_udp udp;
};
...
/* rpc.udp */
#define MGOS_CONFIG_HAVE_RPC_UDP
#define MGOS_SYS_CONFIG_HAVE_RPC_UDP
const struct mgos_config_rpc_udp *mgos_config_get_rpc_udp(const struct mgos_config *cfg);
static inline const struct mgos_config_rpc_udp *mgos_sys_config_get_rpc_udp(void) { return mgos_config_get_rpc_udp(&mgos_sys_config); }

/* rpc.udp.listen_addr */
#define MGOS_CONFIG_HAVE_RPC_UDP_LISTEN_ADDR
#define MGOS_SYS_CONFIG_HAVE_RPC_UDP_LISTEN_ADDR
const char * mgos_config_get_rpc_udp_listen_addr(const struct mgos_config *cfg);
const char * mgos_config_get_default_rpc_udp_listen_addr(void);
static inline const char * mgos_sys_config_get_rpc_udp_listen_addr(void) { return mgos_config_get_rpc_udp_listen_addr(&mgos_sys_config); }
static inline const char * mgos_sys_config_get_default_rpc_udp_listen_addr(void) { return mgos_config_get_default_rpc_udp_listen_addr(); }
void mgos_config_set_rpc_udp_listen_addr(struct mgos_config *cfg, const char * v);
static inline void mgos_sys_config_set_rpc_udp_listen_addr(const char * v) { mgos_config_set_rpc_udp_listen_addr(&mgos_sys_config, v); }

/* rpc.udp.dst_addr */
#define MGOS_CONFIG_HAVE_RPC_UDP_DST_ADDR
#define MGOS_SYS_CONFIG_HAVE_RPC_UDP_DST_ADDR
const char * mgos_config_get_rpc_udp_dst_addr(const struct mgos_config *cfg);
const char * mgos_config_get_default_rpc_udp_dst_addr(void);
static inline const char * mgos_sys_config_get_rpc_udp_dst_addr(void) { return mgos_config_get_rpc_udp_dst_addr(&mgos_sys_config); }
static inline const char * mgos_sys_config_get_default_rpc_udp_dst_addr(void) { return mgos_config_get_default_rpc_udp_dst_addr(); }
void mgos_config_set_rpc_udp_dst_addr(struct mgos_config *cfg, const char * v);
static inline void mgos_sys_config_set_rpc_udp_dst_addr(const char * v) { mgos_config_set_rpc_udp_dst_addr(&mgos_sys_config, v); }

/* rpc.udp.dst */
#define MGOS_CONFIG_HAVE_RPC_UDP_DST
#define MGOS_SYS_CONFIG_HAVE_RPC_UDP_DST
const char * mgos_config_get_rpc_udp_dst(const struct mgos_config *cfg);
const char * mgos_config_get_default_rpc_udp_dst(void);
static inline const char * mgos_sys_config_get_rpc_udp_dst(void) { return mgos_config_get_rpc_udp_dst(&mgos_sys_config); }
static inline const char * mgos_sys_config_get_default_rpc_udp_dst(void) { return mgos_config_get_default_rpc_udp_dst(); }
void mgos_config_set_rpc_udp_dst(struct mgos_config *cfg, const char * v);
static inline void mgos_sys_config_set_rpc_udp_dst(const char * v) { mgos_config_set_rpc_udp_dst(&mgos_sys_config, v); }
...
#define MGOS_CONFIG_HAVE_APP_SSD1306_RESET_PIN
#define MGOS_SYS_CONFIG_HAVE_APP_SSD1306_RESET_PIN
int mgos_config_get_app_ssd1306_reset_pin(const struct mgos_config *cfg);
int mgos_config_get_default_app_ssd1306_reset_pin(void);
static inline int mgos_sys_config_get_app_ssd1306_reset_pin(void) { return mgos_config_get_app_ssd1306_reset_pin(&mgos_sys_config); }
static inline int mgos_sys_config_get_default_app_ssd1306_reset_pin(void) { return mgos_config_get_default_app_ssd1306_reset_pin(); }
void mgos_config_set_app_ssd1306_reset_pin(struct mgos_config *cfg, int v);
static inline void mgos_sys_config_set_app_ssd1306_reset_pin(int v) { mgos_config_set_app_ssd1306_reset_pin(&mgos_sys_config, v); }
