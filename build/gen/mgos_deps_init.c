...
const struct mgos_lib_info mgos_libs_info[] = {
    ...
    {.name = "arduino-adafruit-gfx", .version = "1.0", .init = mgos_arduino_adafruit_gfx_init},

    // "spi". deps: [ "core" ]
    {.name = "spi", .version = "1.0", .init = mgos_spi_init},

    // "arduino-spi". deps: [ "arduino-compat" "core" "spi" ]
    {.name = "arduino-spi", .version = "1.0", .init = mgos_arduino_spi_init},
    ...
    {.name = "arduino-adafruit-ssd1306", .version = "1.0", .init = mgos_arduino_adafruit_ssd1306_init},
    ...
    // "rpc-udp". deps: [ "core" "rpc-common" ]
    {.name = "rpc-udp", .version = "1.0", .init = mgos_rpc_udp_init},
