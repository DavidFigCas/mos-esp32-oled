...
double  sin(double);
double  sqrt(double);
void  ssd1306_drawBitmap(void *, void *, int, int, int, int);
void  ssd1306_splash(void *, void *);
void * strdup(char *);
...
const struct mgos_ffi_export ffi_exports[] = {
  ...
  {"sin", sin},
  {"sqrt", sqrt},
  {"ssd1306_drawBitmap", ssd1306_drawBitmap},
  {"ssd1306_splash", ssd1306_splash},
  {"strdup", strdup},
  {"temprature_sens_read", temprature_sens_read},
};
const int ffi_exports_cnt = 181;
